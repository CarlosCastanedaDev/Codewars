...
function getCard() {
  ...
  while (numbers.size < 5) {
    const number = 'B' + getRandomNumber(1, 15);
    numbers.add(number);
  }
  while (numbers.size < 10) {
    const number = 'I' + getRandomNumber(16, 30);
    numbers.add(number);
  }
  while (numbers.size < 14) {
    const number = 'N' + getRandomNumber(31, 45);
    numbers.add(number);
  }
  while (numbers.size < 19) {
    const number = 'G' + getRandomNumber(46, 60);
    numbers.add(number);
  }
  while (numbers.size < 24) {
    const number = 'O' + getRandomNumber(61, 75);
    numbers.add(number);
  }
